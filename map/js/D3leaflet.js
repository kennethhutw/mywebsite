var map, svg, g;
map = new L.Map('map').setView(new L.LatLng(22.8, 121.9), 7).addLayer(new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'));
svg = d3.select(map.getPanes().overlayPane).append('svg');
g = svg.append('g');
d3.json('data/twCounty2010.json', function(collection){
